...
export function initBuffers(gl) {
    ...
    // Now create an arary of positions for the cube.
...
export function drawScene(gl, programInfo, buffers, texture, rotation) {
    ...
    // and we only want to see object between 0.1 units
    ...
    // Soecify thge texture to map onto the faces.
